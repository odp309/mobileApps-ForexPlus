...
const HistoryScreen = () => {
    ...
    const data = [
        ...
        { id: '8', type: 'Transfer', date: '14 April 2024', amount: '+ AUD 1', color: 'blue', icon: require ('../../../../assets/icon-histori-transfer.png') },
        { id: '9', type: 'Beli', date: '8 April 2024', amount: '+ AUD 1', color: 'purple', icon: require ('../../../../assets/icon-histori-beli.png') },
        { id: '10', type: 'Beli', date: '5 April 2024', amount: '+ AUD 1', color: 'purple', icon: require ('../../../../assets/icon-histori-beli.png') },
        { id: '11', type: 'Beli', date: '1 April 2024', amount: '+ AUD 1', color: 'purple', icon: require ('../../../../assets/icon-histori-beli.png') },
        ...
        const renderItem = ({ item }) => (
          ...
          style={styles.itemContainer} 
              ...
              <BodyMediumTextSemiBold style={[styles.itemAmount, { color: item.amount.startsWith('+') ? 'green' : 'red' }]}>{item.amount}</BodyMediumTextSemiBold>
            </TouchableOpacity>
          );
...
return (
    ...
    <View style={styles.container}>
        ...
        renderItem={renderItem}
        keyExtractor={item => item.id}
        ListHeaderComponent={() => <Text style={styles.sectionHeader}>April 2024</Text>}
      />
      </View>
      </ScrollView>
    </View>
